...
app.controller("myCtrl", function ($scope) {
  ...
  generateSpiral(
    $scope.image,
    parseInt($scope.maxLineWidth),
    parseInt($scope.lineDistance)
  );
...
function generateSpiral(image, maxLineWidth, lineDistance) {
  ...
  img.onload = function () {
    ...
    pointCoordinatesArray = createEquidistantPointsAlongAnArchimedeanSpiral(
      canvasWidth,
      canvasHeight,
      maxPointSize,
      lineDistance
...
function createEquidistantPointsAlongAnArchimedeanSpiral(
  canvasWidth,
  canvasHeight,
  maxPointSize,
  lineDistance
